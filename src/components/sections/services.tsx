...
const services = [
  ...
  },
  {
    ...
    features: [
      ...
      "Biombos acústicos c/ lã de rocha (30-50% redução dB)",
      "Biombos empilháveis, fixação em teto ou veículos",
      "Divisórias móveis articuladas em sanfona",
      "Acabamento sem necessidade de carpete",
    ],
    color: "#3B82F6",
  },
  {
  ...
  },
  {
    ...
    features: [
      "Gerador R$350/dia avulso (grátis em contratos)",
      "Climatizadores de ar com visita técnica",
      "Plantão 24h c/ rádio 30km+ e FM 25W",
      "Escada alumínio, flip chart, laser pointer, púlpito",
      "Tripés de iluminação, cabos AC extras, ferramentas",
