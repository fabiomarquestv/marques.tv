...
const services = [
  ...
  },
  {
    ...
    description: "Gerador de energia com inversores de 300W a 2.000W (pico 4.000W). Plantão 24 horas para eventos contratados.",
    features: [
      "Gerador de energia (incluso em contratos fechados)",
      "Climatizadores de ar",
      "Plantão 24 horas para eventos contratados",
      "Escada de alumínio",
      "Flip chart",
      "Laser pointer",
      "Tripé de alumínio",
