    ...
    <footer className="bg-[#0a0a0f] border-t border-white/10 pt-16 pb-8">
      <div className="container-custom">
            ...
            <div className="flex gap-3 mt-6">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full glass flex items-center justify-center text-gray-400 hover:text-[#00d4aa] hover:border-[#00d4aa]/30 transition-colors"
                >
                  {social.icon}
                </motion.a>
              ))}
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
          ...
          <p className="text-gray-500 text-sm">
            Desenvolvido com <span className="text-[#00d4aa]">Next.js</span> + <span className="text-[#7c3aed]">Magic UI</span>
          </p>
        </div>
      </div>
    </footer>
