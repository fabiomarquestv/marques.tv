...
${formData.message}`;
  ...
  return (
    <section id="contato" className="py-24 relative overflow-hidden">
      ...
      {/* Decorative elements */}
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-[#00d4aa]/10 rounded-full blur-[150px]" />
      <div className="absolute bottom-1/4 left-0 w-96 h-96 bg-[#7c3aed]/10 rounded-full blur-[150px]" />
                ...
                {contactMethods.map((method, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="flex items-center gap-4 p-4 glass rounded-xl hover:border-[#00d4aa]/30 transition-all group"
                    >
                      <div
                      ...
                      <div>
                        <h4 className="font-semibold text-white group-hover:text-[#00d4aa] transition-colors">
                          {method.title}
                        </h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-[#0a0a0f] border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-[#00d4aa] focus:outline-none focus:ring-2 focus:ring-[#00d4aa]/20 transition-all"
                    />
                  </div>
                  <div>
                    <label className="block text-gray-400 text-sm mb-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 bg-[#0a0a0f] border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-[#00d4aa] focus:outline-none focus:ring-2 focus:ring-[#00d4aa]/20 transition-all resize-none"
                  />
                </div>
